...
from models.FCModel_Functional_v2         import FCModel_Functional
...
parser.add_argument('-n', '--neurons'   , default=100, nargs='+', type=int , help='list of neuron numbers (per layer)'         )
